...
export class Backend implements backendInterface {
    ...
    async getAllChatMessages(): Promise<Array<[Principal, ChatMessage]>> {
    ...
    async getInquiriesByEmail(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInquiriesByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentInquiries(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitChatMessage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitChatMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
